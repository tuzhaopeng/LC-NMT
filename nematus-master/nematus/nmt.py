...
def build_model(tparams, options):
    ...
    # VINCENT: this part is used to initialize the decoder
    ...
    # VINCENT: this part is go to GRU
    ...
    # VINCENT: this part is current target hidden state -> current target word.
...
def train(dim_word=100,  # word vector dimensionality
          ...
          finetune=False,
          maxibatch_size=20,
          tune_path='/home/vwang/my_work/Research/dialogue_context/script-nmt/common/tune.txt'): #How many minibatches to load at one time
